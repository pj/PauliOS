...
public class KThread {
	...
	public static KThread currentThread() {
		Lib.assert_(currentThread != null);
	...
	private void begin() {
		...
		Lib.assert_(this == currentThread);
	...
	public static void yield() {
		...
		Lib.assert_(currentThread.status == statusRunning);
	...
	public static void sleep() {
		...
		Lib.assert_(Machine.interrupt().disabled());
	...
	public void ready() {
		...
		Lib.assert_(Machine.interrupt().disabled());
		Lib.assert_(status != statusReady);
	...
	protected void restoreState() {
		...
		Lib.assert_(Machine.interrupt().disabled());
		Lib.assert_(this == currentThread);
		Lib.assert_(tcb == TCB.currentTCB());
